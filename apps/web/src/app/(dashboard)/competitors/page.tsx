        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="w-full max-w-[400px] glass rounded-[var(--radius-xl)] p-6 relative">
            ...
            <div className="space-y-4">
              ...
              <button type="button" onClick={handleAddCompetitor} className="w-full flex items-center justify-center gap-1.5 bg-[var(--color-primary)] text-[var(--color-text-inverse)] text-xs font-semibold py-3 rounded-[var(--radius-md)] hover:opacity-90 active:scale-95">
