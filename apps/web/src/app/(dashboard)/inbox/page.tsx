          ...
          {activeConv ? (
            <>
                  ...
                  return (
                    <div key={idx} className={`flex ${isMe ? "justify-end" : "justify-start"}`}>
                      <div className={`max-w-[70%] p-3 rounded-[var(--radius-md)] text-xs border ${
                        isMe 
                          ? "bg-[var(--color-primary)] border-transparent text-white rounded-br-none shadow-[var(--shadow-glow)]" 
              ...
              <form onSubmit={handleSendReply} className="p-4 border-t border-[var(--color-border)] bg-[var(--color-surface)] flex gap-3 shrink-0">
                ...
                <button
                  type="submit"
                  className="px-5 bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-accent)] text-white text-xs font-semibold rounded-[var(--radius-md)] flex items-center gap-1.5 shadow-[var(--shadow-glow)] hover:opacity-90 active:scale-95"
                >
